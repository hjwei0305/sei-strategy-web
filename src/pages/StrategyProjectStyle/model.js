...
import { del, save,findByPage,downloadTemplate,uploadStrategyProjectStyle } from './service';

const { dvaModel } = utils;
const { modelExtend, model } = dvaModel;

export default modelExtend(model, {
  namespace: 'strategyProjectStyle',
  ...
  effects: {
    ...
    *uploadStrategyProjectStyle({ payload }, { call }) {
